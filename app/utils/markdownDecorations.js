                ...
                for (let pos = from; pos <= to;) {
                    ...
                    if (!cursorOnLine) {
                        ...
                        while ((boldMatch = boldRegex.exec(lineText)) !== null) {
                            ...
                            // Style the bold text
                            builder.add(textStart, textEnd, Decoration.mark({ class: "cm-rendered-bold" }));
                        ...
                        while ((italicMatch = italicRegex.exec(lineText)) !== null) {
                            ...
                            builder.add(textStart, textEnd, Decoration.mark({ class: "cm-rendered-italic" }));
                        ...
                        while ((strikethroughMatch = strikethroughRegex.exec(lineText)) !== null) {
                            ...
                            builder.add(textStart, textEnd, Decoration.mark({ class: "cm-rendered-strikethrough" }));
                        ...
                        while ((inlinecodeMatch = inlinecodeRegex.exec(lineText)) !== null) {
                            ...
                            // Style the bold text
                            builder.add(textStart, textEnd, Decoration.mark({ class: "cm-rendered-inlinecode" }));
